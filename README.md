...
- For the data I used in the third example, you can access it from this address. [MockData] (https://www.mockaroo.com/)

## Some npm packages i use
...
Contact Mentor (https://contactmentor.com/)
